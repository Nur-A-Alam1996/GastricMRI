function [seg] = tools_localActiveContour(Img,mask_init,rad,alpha,num_it,epsilon,flag_display)
%{
...
hold on;  contour(imrotate(phi,90), [0 0], 'y','LineWidth',1.5);
