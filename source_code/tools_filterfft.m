%% 
% tools_filterfft() - lowpass, highpass or bandpass filtering using a pair of forward 
%             and inverse fourier transform. 
%
% Usage
%   [ts_new]=tools_filterfft(ts, fs, lowcut, highcut, revfilt, trans)
%
% Inputs
...
function ts_new = tools_filterfft(ts, fs, lowcut, highcut, revfilt, trans)
